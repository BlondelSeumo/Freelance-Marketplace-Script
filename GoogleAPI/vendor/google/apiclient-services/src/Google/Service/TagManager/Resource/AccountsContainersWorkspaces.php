...
class Google_Service_TagManager_Resource_AccountsContainersWorkspaces extends Google_Service_Resource
{
  ...
  /**
   * Gets a GTM Workspace Sideline. (workspaces.getSideline)
   *
   ...
   * @param array $optParams Optional parameters.
   * @return Google_Service_TagManager_WorkspaceSideline
   */
  public function getSideline($path, $optParams = array())
  {
    $params = array('path' => $path);
    $params = array_merge($params, $optParams);
    return $this->call('getSideline', array($params), "Google_Service_TagManager_WorkspaceSideline");
  }
  /**
  ...
  /**
   * Updates a GTM Workspace Sideline. (workspaces.updateSideline)
   *
   * @param string $path GTM workspace proposal's relative path: Example:
   * accounts/{aid}/containers/{cid}/workspace/{wid}/workspace_proposal
   * @param Google_Service_TagManager_UpdateWorkspaceSidelineRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_TagManager_WorkspaceSideline
   */
  public function updateSideline($path, Google_Service_TagManager_UpdateWorkspaceSidelineRequest $postBody, $optParams = array())
  {
    $params = array('path' => $path, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updateSideline', array($params), "Google_Service_TagManager_WorkspaceSideline");
  }
}
