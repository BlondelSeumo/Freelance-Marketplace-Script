...
class Google_Service_AdExchangeBuyer_Resource_Marketplaceprivateauction extends Google_Service_Resource
{
   ...
   * @param Google_Service_AdExchangeBuyer_UpdatePrivateAuctionSidelineRequest $postBody
   * @param array $optParams Optional parameters.
   */
  public function updateproposal($privateAuctionId, Google_Service_AdExchangeBuyer_UpdatePrivateAuctionSidelineRequest $postBody, $optParams = array())
  {
