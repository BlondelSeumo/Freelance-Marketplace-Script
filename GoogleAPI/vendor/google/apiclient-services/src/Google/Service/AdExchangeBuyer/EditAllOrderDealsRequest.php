...
class Google_Service_AdExchangeBuyer_EditAllOrderDealsRequest extends Google_Collection
{
  ...
  protected $proposalType = 'Google_Service_AdExchangeBuyer_Sideline';
  ...
  /**
   * @param Google_Service_AdExchangeBuyer_Sideline
   */
  public function setSideline(Google_Service_AdExchangeBuyer_Sideline $proposal)
  {
   ...
   */
  public function getSideline()
  {
    return $this->proposal;
  }
  public function setSidelineRevisionNumber($proposalRevisionNumber)
  {
    $this->proposalRevisionNumber = $proposalRevisionNumber;
  }
  public function getSidelineRevisionNumber()
  {
