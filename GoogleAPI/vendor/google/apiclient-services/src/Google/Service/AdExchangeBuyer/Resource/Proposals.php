 ...
 *  </code>
 */
class Google_Service_AdExchangeBuyer_Resource_Sidelines extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_AdExchangeBuyer_Sideline
   */
  public function get($proposalId, $optParams = array())
  {
    $params = array('proposalId' => $proposalId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_AdExchangeBuyer_Sideline");
  }
  /**
   ...
   * @param Google_Service_AdExchangeBuyer_Sideline $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_AdExchangeBuyer_Sideline
   */
  public function patch($proposalId, $revisionNumber, $updateAction, Google_Service_AdExchangeBuyer_Sideline $postBody, $optParams = array())
  {
    $params = array('proposalId' => $proposalId, 'revisionNumber' => $revisionNumber, 'updateAction' => $updateAction, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_AdExchangeBuyer_Sideline");
  }
  /**
   ...
   * @return Google_Service_AdExchangeBuyer_Sideline
   */
  public function update($proposalId, $revisionNumber, $updateAction, Google_Service_AdExchangeBuyer_Sideline $postBody, $optParams = array())
  {
    $params = array('proposalId' => $proposalId, 'revisionNumber' => $revisionNumber, 'updateAction' => $updateAction, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Google_Service_AdExchangeBuyer_Sideline");
  }
}
