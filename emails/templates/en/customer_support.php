                ...
                <tr>
                    <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            ...
                            <tr>
                                <td width="48" class="o_bb-light o_text-md o_text-secondary o_sans o_py" align="right"
                                    ...
                                    <img editable="" class="o_br-max" src="<?= img_url("person-circle.png"); ?>"
                                         width="48" height="48" alt="" style="max-width: 48px; position: relative;">
                                </td>
                        ...
                        <?php if (!empty($data['attachment'])) { ?>
                            <a class="o_text-primary" href="#"
                               style="color: #126de5;display: block;padding: 7px 8px;font-weight: bold; font-size: 14px;">
                                <img src="<?= img_url("attachment.png"); ?>" width="24" height="24"
                                     style="max-width: 24px;;vertical-align: middle;"> <?= $data['attachment']; ?>
                            </a>
                        <?php } ?>
                ...
                <tr>
                    <td class="o_bg-white o_px-md o_py" align="left">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            <tbody>
                            <tr>
                                <td width="40" class="o_bg-dark o_br-l o_text-md o_text-white o_sans o_py-xs"
                                    align="right" style="vertical-align:top;">
                                    <img editable="" src="<?= img_url("warning.png"); ?>" width="24" height="24" alt=""
