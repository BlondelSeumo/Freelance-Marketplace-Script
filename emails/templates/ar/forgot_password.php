          ...
          <tbody>
            <tr>
              <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color:<?= $site_color;?>;color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 34px;padding-bottom: 34px;"><table cellspacing="0" cellpadding="0" border="0" role="presentation">
                ...
                <h2 class="o_heading o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 30px;line-height: 39px;">إعادة تعيين كلمة المرور </h2>
                <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">لقد طلبت إعادة تعيين كلمة المرور التي وضعتها للمطاردة </p>
                  ...
                  <tbody>
                    <tr>
                      <td width="300" class="o_btn o_bg-white o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #ffffff;border-radius: 4px;">
                        <a class="o_text-primary" href="<?= $data['forgot_link']; ?>" style="text-decoration: none; outline: none; color: <?= $site_color;?>; display: block; padding: 12px 24px; mso-text-raise: 3px;">تغيير كلمة المرور</a></td>
                    </tr>
                  </tbody>
                </table>
              </td>
...
<div class="o_bg-light o_px-xs" align="center" style="background-color: #e8f2e8;padding-left: 8px;padding-right: 8px;">
  <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
    <tbody>
      <tr>
        <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;"><p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><strong>إذا كان الزر لا يعمل ، فانسخ هذا الرابط
</strong></p>
          ...
          <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
            <tbody>
              <tr>
                ...
                <td class="o_bg-dark o_br-r o_text-xs o_text-white o_sans o_px o_py-xs" align="left" style="vertical-align: top;font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #242b3d;color: #ffffff;border-radius: 0px 4px 4px 0px;padding-left: 16px;padding-right: 16px;padding-top: 8px;padding-bottom: 8px;"><p style="margin-top: 0px;margin-bottom: 0px;"><strong>معلومات.</strong> احتفظ دائمًا بكلمة مرورك في مكان آمن. إذا لم تكن قد طلبت تغيير كلمة المرور ، فأخبرنا بذلك على الفور.
                </p></td>
              </tr>
            </tbody>
          </table>
