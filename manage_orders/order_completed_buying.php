	...
	<table class="table table-bordered">
		...
		<tbody>
            ...
            <?php
                ...
                $sel_orders = $db->select("orders",array("buyer_id" => $login_seller_id,"order_status" => "completed"),"DESC");
...
<?php
   ...
   if($count_orders == 0){
      echo "<center><h3 class='pb-4 pt-4'><i class='fa fa-meh-o'></i> {$lang['buying_orders']['no_completed']} </h3></center>";
   }
